...
namespace Baudrillard.Simulator
{
        ...
        where TResults : SimulationResult, new()
    {
        ...
        protected IList<TShowableStateVector> ShowableStateVectors { get; set; }
        ...
        public SimulationResult Simulate()
        {
            ...
            while (PreviousStateVector.Clock <= Parameters.TimeToSimulate)
            {
                TimeRoutine();
                EventRoutine();
        ...
        public IList<TShowableStateVector> GetShowableStateVectors()
        {
            return ShowableStateVectors as IList<TShowableStateVector>;
        }
